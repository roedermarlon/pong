...
public class ServerTest {
    ...
    public void handle() {
        try {
            ...
            server.responder("test", property -> new TestPacket("polo", property.getInteger("test")));

            client1.responder("players", property -> new TestPacket("polo", property.getInteger("test")));
